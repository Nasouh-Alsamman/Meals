...
function CardDetails4(props) {
console.log(props.arrData[3]);
  return (
    <section className="main">
    <article className="single-product"  >
                <div className="section-left">
                  <div className="img-holder">
                     <img src={props.arrData[3].img} alt="sss" ></img>
                  </div>
                  <p>Roll over image to zoom in</p>
                  <div className="smlimg">
                    <div className="imghold"><img src={props.arrData[3].img} alt="" /></div>
                    <div className="imghold"><img src={props.arrData[3].img} alt="" /></div>
                    <div className="imghold"><img src={props.arrData[3].img} alt="" /></div>
                    <div className="imghold"><img src={props.arrData[3].img} alt="" /></div>    
                    </div>
               ...
               <div className="section-right">
                ...
                <div className="second">
                  <h1>{props.arrData[3].productName}</h1>
